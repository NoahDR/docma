  ...
  return (
    <div className="group/locale relative">
      ...
      <div
        ...
        aria-hidden={!open}
        className={cn(
          "surface-panel surface-panel-strong !absolute right-0 top-[calc(100%+0.6rem)] z-50 min-w-[13.5rem] rounded-[1.25rem] p-1.5 shadow-[var(--surface-shadow-strong)] transition-[opacity,transform] duration-200 ease-[var(--ease-emphasized)]",
